...
export class LostPasswordComponent implements OnInit {
      ...
      this.loginService.lostPassword(this.formGroup.value)
        .subscribe({
          next: result => {
            ...
            this.snackBar.open('Email with link has been sent', '', { duration: 3000, panelClass: "snack-bar-bg-color-ok" });
  ...
  private passwordIdentical(changePassword: any) {
    ...
    this.formChangePasswordError = "Passwords aren't identical";
    return false;
  }
