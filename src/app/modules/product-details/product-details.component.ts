...
export class ProductDetailsComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.reviewForm = this.formBuilder.group({
      authorName: ['', [Validators.required, Validators.max(60)]],
      content: ['', [Validators.required, Validators.max(600)]]
    });
  }
  ...
  submit(): void {
    if(this.reviewForm.valid) {
      ...
      .subscribe(() => {
        ...
        this.snackBar.open("Review was added", '', {duration: 3000, panelClass: "snack-bar-bg-color-ok"});
      });
    }
  }
